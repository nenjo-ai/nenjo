...
## [0.37.0](https://github.com/nenjo-ai/nenjo/compare/v0.36.0...v0.37.0) - 2026-09-11

### Added

- add vLLM Responses streaming and harden ability execution ([#117](https://github.com/nenjo-ai/nenjo/pull/117))

### Fixed

- documentation checks ([#118](https://github.com/nenjo-ai/nenjo/pull/118))

### Other

- Finalized core feature improvements ([#56](https://github.com/nenjo-ai/nenjo/pull/56))

## [0.36.0](https://github.com/nenjo-ai/nenjo/compare/v0.35.0...v0.36.0) - 2026-09-11

### Fixed

- restructure concurrency limits and timeout configs ([#115](https://github.com/nenjo-ai/nenjo/pull/115))
- give cache dir permissions to nenjo user in docker image ([#114](https://github.com/nenjo-ai/nenjo/pull/114))

### Other

- Finalized core feature improvements ([#56](https://github.com/nenjo-ai/nenjo/pull/56))

## [0.35.0](https://github.com/nenjo-ai/nenjo/compare/v0.34.0...v0.35.0) - 2026-09-04

### Other

- Fix/knowledge scope ([#112](https://github.com/nenjo-ai/nenjo/pull/112))
- Finalized core feature improvements ([#56](https://github.com/nenjo-ai/nenjo/pull/56))
...
- open router transcription audio ([#104](https://github.com/nenjo-ai/nenjo/pull/104))

### Other

- Feat/human in the loop ([#105](https://github.com/nenjo-ai/nenjo/pull/105))
- Finalized core feature improvements ([#56](https://github.com/nenjo-ai/nenjo/pull/56))

## [0.31.0](https://github.com/nenjo-ai/nenjo/compare/v0.30.0...v0.31.0) - 2026-07-23

### Other

- Fix/package installer dependencies ([#102](https://github.com/nenjo-ai/nenjo/pull/102))
- Finalized core feature improvements ([#56](https://github.com/nenjo-ai/nenjo/pull/56))
