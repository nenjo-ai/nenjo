//! Re-exports security types from `nenjo-tools` and provides the
//! harness-specific `from_config` factory.

pub use nenjo_tools::security::{ActionTracker, AutonomyLevel, CommandRiskLevel, SecurityPolicy};
...
/// Build a [`SecurityPolicy`] from harness config sections.
///
/// This is a standalone function because `SecurityPolicy` is defined in
