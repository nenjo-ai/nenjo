...
3. Runtime context: user message, task, routine, gate, memory, artifacts, and available resources.
...
Use `{{ artifacts }}` when saved artifacts or workspace outputs matter.
...
- Keeps generated artifacts separate from learned memory.
