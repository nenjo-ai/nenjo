...
//! |-----------|---------------------|------------------|-----------|
//! | Backend → Harness | `work_requests.<org_id>.<capability>` / `worker_requests.<org_id>.<worker_id>.<capability>` / `broadcast_requests.<org_id>.<capability>` | `work_requests.<org_id>.<capability>` / `worker_requests.<org_id>.<worker_id>.<capability>` / `broadcast_requests.<org_id>.<capability>` | [`Command`] |
//! | Harness → Backend | `responses.<org_id>.<user_id>` / `streams.chat.<org_id>.<session_id>` | `responses.<org_id>.<user_id>` / `streams.chat.<org_id>.<session_id>` | [`Response`] |
//!
//! ## Wire format
//!
