...
//! |-----------------------------------------|----------------------------|
//! | `work_requests.<org_id>.>`              | `work_requests.>`          |
//! | `worker_requests.<org_id>.<worker_id>.>` | `worker_requests.<worker_id>.>` |
//! | `broadcast_requests.<org_id>.>`         | `broadcast_requests.>`     |
...
/// `broadcast_requests.<capability>`
pub fn broadcast_requests_subject(capability: Capability) -> String {
    format!("broadcast_requests.{capability}")
}
