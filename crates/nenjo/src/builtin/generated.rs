...
pub static BUILTIN_DOCS: &[BuiltinKnowledgeDoc] = &[
    ...
    doc!(
        ...
        include_str!("../../knowledge/docs/guide/abilities.md")
    ),
    doc!(
        "nenjo.guide.agents",
        "builtin://nenjo/guide/agents.md",
        include_str!("../../knowledge/docs/guide/agents.md")
    ),
    doc!(
    ...
    doc!(
        ...
        include_str!("../../knowledge/docs/taxonomy/workflow_patterns.md")
    ),
];
